      ...
      <div ref={ref} className="mx-auto max-w-4xl px-6 text-center lg:px-10">
        ...
        >
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 border border-[#c9a96e] px-8 py-4 text-xs uppercase tracking-[0.25em] text-[#c9a96e] transition-all duration-300 hover:bg-[#c9a96e] hover:text-[#2a2318]"
            >
              Book Now
              <ExternalLink size={14} />
            </a>
