  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="relative w-full h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden rounded-[5px]">
          ...
          <Image
            ...
            fill
            className={`object-cover transition-all duration-1000 ease-out rounded-[5px] ${isInView ? "opacity-100 scale-100" : "opacity-0 scale-95"
              }`}
            priority
            sizes="100vw"
          />
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-black/40 rounded-[5px]" />
